...
class DefaultAnnotationGeneratorTest extends ObjectMother {
    ...
    class DefaultConfig {
        ...
        void shouldAnnotateClasses() {
            // given
            final var generator = new DefaultAnnotationGenerator(yoSqlComponent().annotationConfiguration(), yoSqlComponent().translator());
    ...
    class CustomConfig {
        ...
        void shouldWriteDate() {
            // given
            final var config = AnnotationConfiguration.copy(yoSqlComponent().annotationConfiguration())
                    .withMethodMembers(ALL);
            final var generator = new DefaultAnnotationGenerator(config, yoSqlComponent().translator());
