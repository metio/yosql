...
import static wtf.metio.yosql.i18n.I18nObjectMother.translator;
...
class DefaultAnnotationGeneratorTest {
    ...
    class DefaultConfig {
        ...
        void shouldAnnotateClasses() {
            // given
            final var config = annotationConfig();
            final var generator = new DefaultAnnotationGenerator(config, translator());
    ...
    class CustomConfig {
        ...
        void shouldWriteDate() {
            // given
            final var config = AnnotationConfiguration.copy(annotationConfig())
