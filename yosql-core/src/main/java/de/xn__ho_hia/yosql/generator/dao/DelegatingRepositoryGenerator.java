...
final class DelegatingRepositoryGenerator implements RepositoryGenerator {
    ...
    @Override
    public void generateRepository(final String repositoryName, final List<SqlStatement> statements) {
        jdbcRepositoryGenerator.generateRepository(repositoryName, statements);
    }
