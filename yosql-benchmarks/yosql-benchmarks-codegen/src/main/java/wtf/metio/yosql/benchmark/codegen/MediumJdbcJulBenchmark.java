...
/**
 * JMH based micro benchmark for YoSQL using the JDBC API and java.util.logging as logging implementation using a medium
 ...
 */
public class MediumJdbcJulBenchmark extends AbstractMediumSampleBenchmark {
