...
/**
 * JMH based micro benchmark for YoSQL using the JDBC API and tinylog as logging implementation using a large
 ...
 */
public class LargeJdbcTinylogBenchmark extends AbstractLargeSampleBenchmark {
