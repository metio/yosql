...
/**
 * JMH based micro benchmark for YoSQL using the JDBC API and slf4j as logging implementation using a medium
 ...
 */
public class MediumJdbcSlf4jBenchmark extends AbstractMediumSampleBenchmark {
