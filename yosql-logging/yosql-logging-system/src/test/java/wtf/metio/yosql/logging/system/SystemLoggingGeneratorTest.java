...
class SystemLoggingGeneratorTest {

    private SystemLoggingGenerator generator;

    @BeforeEach
    void setUp() {
        generator = new SystemLoggingGenerator(NamesConfigurations.defaults(), Blocks.fields());
    }

    @Test
    void logger() {
        final var logger = generator.logger(TypeName.OBJECT);
        ...
        Assertions.assertEquals("""
                ...
                private static final java.lang.System.Logger LOG = java.lang.System.Logger.getLogger("java.lang.Object");
                """, logger.get().toString());
    }
    ...
    void queryPicked() {
        Assertions.assertEquals("""
                LOG.log(java.lang.System.Logger.Level.DEBUG, java.lang.String.format("Picked query [%s]", "test"));
    ...
    void indexPicked() {
        Assertions.assertEquals("""
                LOG.log(java.lang.System.Logger.Level.DEBUG, java.lang.String.format("Picked index [%s]", "test"));
    ...
    void shouldLog() {
        Assertions.assertEquals("""
                LOG.isLoggable(java.lang.System.Logger.Level.INFO)""", generator.shouldLog().toString());
    }
    ...
    void entering() {
        Assertions.assertEquals("""
                LOG.log(java.lang.System.Logger.Level.DEBUG, java.lang.String.format("Entering [%s#%s]", "repo", "method"));
