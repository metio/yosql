...
class JdbcMutinyMethodGeneratorTest {
    ...
    class Defaults implements MutinyMethodGeneratorTCK {
        ...
        @Override
        public String mutinyReadMethodExpectation() {
            return """
                    /**
        ...
        @Override
        public String mutinyReadMethodUsingCustomConverterExpectation() {
            return """
                    /**
                     * <p>Executes the following statement:</p>
                     * <pre>
                    ...
                    public final io.smallrye.mutiny.Multi<com.example.domain.Item> queryDataMulti(
                        final java.lang.Object test, final int id) {
                      LOG.entering("com.example.persistence.DataRepository", "queryDataMulti");
                      try (final var connection = dataSource.getConnection()) {
                        final var query = QUERY_DATA;
