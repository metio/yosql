...
final class MavenModelGenerator extends AbstractModelGenerator {

    @Override
    protected List<TypeSpec> typesFor(final ConfigurationGroup group) {
        return group.mavenTypes();
    }
