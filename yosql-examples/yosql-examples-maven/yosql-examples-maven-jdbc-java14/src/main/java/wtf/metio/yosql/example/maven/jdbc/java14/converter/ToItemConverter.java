 ...
 * in the LICENSE file.
 */
package wtf.metio.yosql.example.maven.jdbc.java14.converter;

import wtf.metio.yosql.example.maven.jdbc.java14.model.Item;
import wtf.metio.yosql.example.maven.jdbc.java14.persistence.util.ResultState;
