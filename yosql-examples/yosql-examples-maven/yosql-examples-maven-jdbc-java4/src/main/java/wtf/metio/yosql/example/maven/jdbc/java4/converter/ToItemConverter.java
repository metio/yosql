 ...
 * in the LICENSE file.
 */
package wtf.metio.yosql.example.maven.jdbc.java4.converter;

import wtf.metio.yosql.example.maven.jdbc.java4.model.Item;
import wtf.metio.yosql.example.maven.jdbc.java4.persistence.converter.ResultState;
