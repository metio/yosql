 ...
 * in the LICENSE file.
 */
package wtf.metio.yosql.example.maven.jdbc.java8.converter;

import wtf.metio.yosql.example.maven.jdbc.java8.model.Item;
import wtf.metio.yosql.example.maven.jdbc.java8.persistence.converter.ResultState;
