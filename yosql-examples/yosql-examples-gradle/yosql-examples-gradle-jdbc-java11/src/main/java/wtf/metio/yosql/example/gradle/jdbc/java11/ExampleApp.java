 ...
 * in the LICENSE file.
 */
package wtf.metio.yosql.example.gradle.jdbc.java11;
...
import wtf.metio.yosql.example.gradle.jdbc.java11.persistence.*;

public final class ExampleApp {

    public static void main(final String[] arguments) {
        try (final var dataSource = DataSourceCreator.createDataSource("java11")) {
