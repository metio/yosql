 ...
 * in the LICENSE file.
 */
package wtf.metio.yosql.tooling.codegen.generator.dao.spring_data_jdbc;
 ...
 */
@Module
public class DAO_Spring_Data_JDBC_Module {
    ...
    RepositoryGenerator provideRepositoryGenerator(
            ...
            final @Spring_Data_JDBC FieldsGenerator fields,
            final @Spring_Data_JDBC MethodsGenerator methods) {
    ...
    MethodsGenerator provideMethodsGenerator(
            final @Spring_Data_JDBC BatchMethodGenerator batchMethods,
            final @Spring_Data_JDBC Java8StreamMethodGenerator streamMethods,
            final @Spring_Data_JDBC RxJavaMethodGenerator rxjavaMethods,
            final @Spring_Data_JDBC StandardMethodGenerator standardMethods,
            final @Spring_Data_JDBC ConstructorGenerator constructor) {
    ...
    ConstructorGenerator provideConstructorGenerator(
        ...
        return new SpringDataJdbcConstructorGenerator(blocks, methods, jdbcNames, jdbcParameters);
    }
    ...
    FieldsGenerator provideFieldsGenerator(
            ...
            final JdbcNames jdbcNames,
            final Javadoc javadoc) {
        return new SpringDataJdbcFieldsGenerator(fields, logging, jdbcFields, jdbcNames, javadoc);
    }
